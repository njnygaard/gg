...
## Installation
    ...
    go get -u github.com/njnygaard/gg

Alternatively, you may use gopkg.in to grab a specific major-version:

    go get -u gopkg.in/njnygaard/gg.v1

## Documentation

- godoc: https://godoc.org/github.com/njnygaard/gg
- pkg.go.dev: https://pkg.go.dev/github.com/njnygaard/gg?tab=doc
...
import "github.com/njnygaard/gg"
...
There are [lots of examples](https://github.com/njnygaard/gg/tree/master/examples) included. They're mostly for testing the code, but they're good for learning, too.
